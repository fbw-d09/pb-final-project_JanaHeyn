...
console.log();
console.log(freeky.attack(blitz, elfie));
console.log();
console.log(freeky.attack(wasserfontäne, elfie));
console.log();
console.log(elfie.getStatus());
console.log();
console.log(freeky.getStatus());
...
console.log(freeky.getStatus());
console.log();
console.log(elfie.attack(bombe, freeky));
console.log();
console.log(elfie.getMagic());
console.log();
console.log(freeky.learnSkill(versteinerung));
console.log();
console.log(elfie.attack(bombe, freeky));
console.log();
console.log(elfie.getStatus());
